...
from tool.ExFractaldataset import ExFractal_dataset
...
def create_dataloader(data_cfg, is_training=True):
    ...
    if is_training:
        ...
        if "rmvs" in data_cfg.baseinfo.name:
            print("dataset's name include rmvs")
        ...
        print(f'Data augmentation for Train is as follows \n{transform}\n')
        ...
        print(f'Data augmentation for Eval is as follows \n{transform}\n')
