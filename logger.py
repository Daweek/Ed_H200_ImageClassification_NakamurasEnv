...
class WandBLogger():
    def __init__(self, cfg):
        self.cfg = cfg
        # wandb.login(key="1f6461febebe3a677cd0465561652aecd814b0e0")
        self.logger = wandb.init(entity='daweek', project='timmain', name=cfg.logger.group, group=cfg.mode, config=cfg)
...
class SmoothedValue(object):
    ...
    def synchronize_between_processes(self):
        ...
        dist.barrier()
        # print(colored("Reducing Tensors...","cyan"))
        dist.all_reduce(t)
        t = t.tolist()
        self.count = int(t[0])
        self.total = t[1]
        # print(colored("Count: {}.".format(self.count),"cyan"))
        # print(colored("Total: {}.".format(self.total),"cyan"))
...
class MetricLogger(object):
    ...
    def synchronize_between_processes(self):
        # print(colored("Meters: {}".format(self.meters),"red"))
